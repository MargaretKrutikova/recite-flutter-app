...
class Citations$query_root$collections$citations$authors with EquatableMixin {
  Citations$query_root$collections$citations$authors();

  factory Citations$query_root$collections$citations$authors.fromJson(
          Map<String, dynamic> json) =>
      _$Citations$query_root$collections$citations$authorsFromJson(json);
  ...
  Map<String, dynamic> toJson() =>
      _$Citations$query_root$collections$citations$authorsToJson(this);
}

@JsonSerializable(explicitToJson: true)
class Citations$query_root$collections$citations with EquatableMixin {
